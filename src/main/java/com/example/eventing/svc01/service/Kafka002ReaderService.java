...
@Component
@Slf4j
public class Kafka002ReaderService {
    ...
    public Kafka002ReaderService(
            @Value("${kafka.consumers.consumer002.bootstrap-servers}") String bootstrapServers,
            @Value("${kafka.consumers.consumer002.topic}") String topic,
            @Value("${kafka.consumers.consumer002.group-id}") String groupId,
            @Value("${kafka.consumers.consumer002.keyDeserializer}") String keyDeserializer,
            @Value("${kafka.consumers.consumer002.valueDeserializer}") String valueDeserializer,
            @Value("${kafka.consumers.consumer002.auto-offset-reset}") String autoOffsetReset,
            @Value("${kafka.consumers.consumer002.enable-auto-commit}") String enableAutoCommit,
            @Value("${appConfig.outFileNames.file002}") String fname
    ) {
